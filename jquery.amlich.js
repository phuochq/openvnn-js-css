...
(function( $ ) {
  ...
  var settings = {},
      ABOUT  = 'Ă‚m lá»‹ch Viá»‡t Nam - Version 0.\nÂ© 2004 Há»“ Ngá»c Äá»©c [http://www.informatik.uni-leipzig.de/~duc/amlich/]',
      TK13 = new Array(
      ...
      CAN = ['GiĂ¡p', 'áº¤t', 'BĂ­nh', 'Äinh', 'Máº­u', 'Ká»·', 'Canh', 'TĂ¢n', 'NhĂ¢m', 'QuĂ½'],
      CHI = ['TĂ½', 'Sá»­u', 'Dáº§n', 'Máº¹o', 'ThĂ¬n', 'Tá»µ', 'Ngá»', 'MĂ¹i', 'ThĂ¢n', 'Dáº­u', 'Tuáº¥t', 'Há»£i'],
      TUAN = ['Chá»§ Nháº­t', 'Thá»© Hai', 'Thá»© Ba', 'Thá»© TÆ°', 'Thá»© NÄƒm', 'Thá»© SĂ¡u', 'Thá»© Báº£y'],
      GIO_HD = ['110100101100', '001101001011', '110011010010', '101100110100', '001011001101', '010010110011'],
      TIETKHI = ['XuĂ¢n phĂ¢n', 'Thanh minh', 'Cá»‘c vÅ©', 'Láº­p háº¡', 'Tiá»ƒu mĂ£n', 'Mang chá»§ng',
        'Háº¡ chĂ­', 'Tiá»ƒu thá»­', 'Äáº¡i thá»­', 'Láº­p thu', 'Xá»­ thá»­', 'Báº¡ch lá»™',
        'Thu phĂ¢n', 'HĂ n lá»™', 'SÆ°Æ¡ng giĂ¡ng', 'Láº­p Ä‘Ă´ng', 'Tiá»ƒu tuyáº¿t', 'Äáº¡i tuyáº¿t',
        'ÄĂ´ng chĂ­', 'Tiá»ƒu hĂ n', 'Äáº¡i hĂ n', 'Láº­p xuĂ¢n', 'VÅ© thá»§y', 'Kinh tráº­p'
      ],
      THANG = ['Má»™t', 'Hai', 'Ba', 'Bá»‘n', 'NÄƒm', 'SĂ¡u', 'Báº£y', 'TĂ¡m', 'ChĂ­n', 'MÆ°á»i', 'MÆ°á»i má»™t', 'MÆ°á»i hai'],
      DAYNAMES = ['C. Nháº­t', 'Thá»© 2', 'Thá»© T3', 'Thá»© 4', 'Thá»© 5', 'Thá»© 6', 'Thá»© 7'],
      LE = {
        solar: [
          { d:  1, m:  1, i: 'Táº¿t DÆ°Æ¡ng lá»‹ch' },
          { d:  9, m:  1, i: 'NgĂ y Há»c sinh - Sinh viĂªn Viá»‡t Nam' },
          { d:  3, m:  2, i: 'NgĂ y thĂ nh láº­p Äáº£ng Cá»™ng sáº£n Viá»‡t Nam' },
          { d: 27, m:  2, i: 'NgĂ y Tháº§y thuá»‘c Viá»‡t Nam' },
          { d:  8, m:  3, i: 'NgĂ y Quá»‘c táº¿ Phá»¥ ná»¯' },
          { d: 26, m:  3, i: 'NgĂ y thĂ nh láº­p ÄoĂ n Thanh niĂªn Cá»™ng sáº£n Há»“ ChĂ­ Minh' },
          { d: 21, m:  4, i: 'NgĂ y SĂ¡ch Viá»‡t Nam' },
          { d: 30, m:  4, i: 'NgĂ y Thá»‘ng nháº¥t Ä‘áº¥t nÆ°á»›c' },
          { d:  1, m:  5, i: 'NgĂ y Quá»‘c táº¿ Lao Ä‘á»™ng' },
          { d: 15, m:  5, i: 'NgĂ y thĂ nh láº­p Äá»™i Thiáº¿u niĂªn Tiá»n phong Há»“ ChĂ­ Minh' },
          { d: 19, m:  5, i: 'NgĂ y sinh cá»§a Chá»§ tá»‹ch Há»“ ChĂ­ Minh' },
          { d:  1, m:  6, i: 'NgĂ y Quá»‘c táº¿ Thiáº¿u nhi' },
          { d:  5, m:  6, i: 'NgĂ y BĂ¡c Há»“ ra Ä‘i tĂ¬m Ä‘Æ°á»ng cá»©u nÆ°á»›c' },
          { d: 27, m:  7, i: 'NgĂ y ThÆ°Æ¡ng binh Liá»‡t sÄ©' },
          { d: 19, m:  8, i: 'NgĂ y CĂ¡ch máº¡ng thĂ¡ng TĂ¡m thĂ nh cĂ´ng' },
          { d:  2, m:  9, i: 'NgĂ y Quá»‘c khĂ¡nh' },
          { d: 13, m: 10, i: 'NgĂ y Doanh nhĂ¢n Viá»‡t Nam' },
          { d: 20, m: 10, i: 'NgĂ y thĂ nh láº­p Há»™i Phá»¥ ná»¯ Viá»‡t Nam' },
          { d: 20, m: 11, i: 'NgĂ y NhĂ  giĂ¡o Viá»‡t Nam' },
          { d: 22, m: 12, i: 'NgĂ y thĂ nh láº­p QuĂ¢n Ä‘á»™i NhĂ¢n dĂ¢n Viá»‡t Nam' },
          { d: 24, m: 12, i: 'NgĂ y Lá»… GiĂ¡ng Sinh' }
        ],
        lunar: [
          { d:  1, m:  1, i: 'Táº¿t NguyĂªn ÄĂ¡n' },
          { d: 15, m:  1, i: 'Táº¿t NguyĂªn tiĂªu' },
          { d:  3, m:  3, i: 'Táº¿t HĂ n thá»±c' },
          { d: 10, m:  3, i: 'Giá»— Tá»• HĂ¹ng VÆ°Æ¡ng' },
          { d: 15, m:  4, i: 'Lá»… Pháº­t Äáº£n' },
          { d:  5, m:  5, i: 'Táº¿t Äoan ngá»' },
          { d: 15, m:  7, i: 'Vu Lan' },
          { d: 15, m:  8, i: 'Táº¿t Trung thu' },
          { d: 23, m: 12, i: 'Ă”ng TĂ¡o cháº§u trá»i' }
        ]
      },
  ...
  function getDayName(lunarDate) {
    ...
    var s = "NgĂ y " + cc[0] +", thĂ¡ng "+cc[1] + ", nÄƒm " + cc[2];
    return s;
  }
  ...
  function getDayString(lunar, solarDay, solarMonth, solarYear) {
    ...
    s += " (Ă‚m lá»‹ch: ";
    s = s + "NgĂ y " + lunar.day+" thĂ¡ng "+lunar.month;
    if (lunar.leap == 1) {
      s = s + " nhuáº­n";
    }
    return s;
  ...
  function getTodayString() {
    ...
    s += " nÄƒm " + getYearCanChi(currentLunarDate.year) + ')';
    return s;
  }
  ...
  function printYear(yy) {
    var yearName = "NÄƒm " + getYearCanChi(yy) + " " + yy;
    var res = "";
  ...
  function printHead(mm, yy) {
    ...
    switch ( settings.type ) {
      ...
      case 'calendar':
        ...
        res += '      <tbody>\n';
        res += '        <tr>\n';
        res += '          <td colspan="2" class="calendar-month">ThĂ¡ng '+(today.getMonth()+1)+' NÄƒm '+today.getFullYear()+'</td>\n';
        res += '        </tr>\n';
        res += '        <tr>\n';
        ...
        res += '            <span class="lunar-month-name">ThĂ¡ng '+THANG[currentLunarDate.month-1]+'</span><br>\n';
        ...
        res += '            <span>NgĂ y <strong>'+cc[0]+'</strong></span><br>\n';
        res += '            <span>ThĂ¡ng <strong>'+cc[1]+'</strong></span><br>\n';
        res += '            <span>Giá» Ä‘áº§u <strong>'+(getCanHour0(currentLunarDate.jd)+' '+CHI[0])+'</strong></span><br>\n';
        res += '            <span>Tiáº¿t <strong>'+TIETKHI[getSunLongitude(currentLunarDate.jd + 1, 7.0)]+'</strong></span><br>\n';
        res += '            <span>PL: <strong>'+getPhatLich()+'</strong></span>\n';
        res += '          </td>\n';
        res += '        </tr>\n';
        res += '        <tr class="calendar-holiday">'+(holiday!='' ? '<td colspan="2">'+holiday+'</td>' : '')+'</tr>\n';
        res += '        <tr>\n';
        res += '          <td colspan="2" class="calendar-hoangdao">Giá» hoĂ ng Ä‘áº¡o: '+getGioHoangDao(currentLunarDate.jd)+'</td>\n';
        res += '        </tr>\n';
        res += '      </tbody>\n';
        res += '    </table>\n';
        res += '  </td>\n';
  ...
  $.fn.amLich = function( options ) {
    ...
    $this.on('click', 'td.ngaythang, td.homnay, td.tet, td.leam, td.leduong', function(e) {
      ...
      switch ( settings.type ) {
        case 'year':
        case 'month':
          s += 'â— ' + getDayString(lunar, sday, smonth, syear) + ' Ă¢m lá»‹ch)\n';
          s += 'â— NgĂ y '+cc[0]+', thĂ¡ng '+cc[1]+', nÄƒm '+cc[2]+'\n';
          s += 'â— Giá» Ä‘áº§u ngĂ y '+(getCanHour0(jd)+' '+CHI[0])+'\n';
          s += 'â— Tiáº¿t '+TIETKHI[getSunLongitude(jd + 1, 7.0)]+'\n';
          s += 'â— Giá» hoĂ ng Ä‘áº¡o: ' + getGioHoangDao(jd) + '\n';
          s += 'â— PL: ' + getPhatLich(dd, mm, yy) + '\n';
          s += ( holiday != '' ? 'â— '+holiday : '' );
          alert(s);
          break;
        case 'calendar':
          $this.find('.calendar .calendar-month').html('ThĂ¡ng '+smonth+' NÄƒm '+syear);
          ...
          $this.find('.calendar .lunar-month-name').html('ThĂ¡ng '+THANG[mm-1]+(leap == 1 ? ' (N)' : ''));
          ...
          $this.find('.calendar .calendar-hoangdao').html('Giá» hoĂ ng Ä‘áº¡o: '+getGioHoangDao(jd));
          s += '<span>NgĂ y <strong>'+cc[0]+'</strong></span><br>\n';
          s += '<span>ThĂ¡ng <strong>'+cc[1]+'</strong></span><br>\n';
          s += '<span>Giá» Ä‘áº§u <strong>'+(getCanHour0(jd)+' '+CHI[0])+'</strong></span><br>\n';
          s += '<span>Tiáº¿t <strong>'+TIETKHI[getSunLongitude(jd + 1, 7.0)]+'</strong></span><br>';
